...
package com.joker.livingstone.provider;
        ...
        public boolean onMenuItemClick(MenuItem item) {
            if (listener == null) {
                ...
                if (listener instanceof OnShareIntentUpdateListener) {
                    ...
                    Bundle b = onShareIntentUpdateListener.onShareIntentExtrasUpdate();
                    shareIntent.putExtra(Intent.EXTRA_SUBJECT, "分享");
                    shareIntent.putExtra(Intent.EXTRA_TEXT, b.getString(Intent.EXTRA_TEXT));
                    shareIntent.putExtra(Intent.EXTRA_TITLE, "活石分享");
