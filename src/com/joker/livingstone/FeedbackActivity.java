...
public class FeedbackActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			// contact info entry
			// View contact_entry =
			// findViewById(R.id.umeng_fb_conversation_contact_entry);
			//
			...
			// .umeng_fb_slide_in_from_right(FeedbackActivity.this),
			// com.umeng.fb.res.AnimMapper
			// .umeng_fb_slide_out_from_left(FeedbackActivity.this));
			// }
			// }
			//
			// });
					...
					new OnClickListener() {
						...
						public void onClick(View v) {
							...
							if (content == null || content.equals("")){
								Toast.makeText(FeedbackActivity.this, "让吐槽来的更猛烈些吧～", Toast.LENGTH_LONG).show();
								return;
							}
	...
	// int topPadding = (int) (((historicalY - mLastMotionY) - headerHeight) /
	// 1.7);
	//
	// header.setVisibility(View.VISIBLE);
